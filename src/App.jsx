...
const RIDES = [
  { id:"hagrids",    name:"Hagrid's Motorbike Adventure",          land:"Hogsmeade",      park:"ioa",     minH:48, express:true,  single:false, dur:7,  thrill:true,  day1:1,  day2:null, tip:"Express Pass works here — but still rope drop worthy. Waits hit 120min+ by 10am even with Express. Go first." },
  { id:"hippogriff", name:"Flight of the Hippogriff",              land:"Hogsmeade",      park:"ioa",     minH:36, express:true,  single:false, dur:2,  thrill:false, day1:2,  day2:null, tip:"Junior coaster right in Hogsmeade — knock it out immediately after Hagrid's while you're already there." },
  { id:"trolley",    name:"High in the Sky Seuss Trolley Train",   land:"Seuss Landing",  park:"ioa",     minH:36, express:true,  single:false, dur:5,  thrill:false, day1:3,  day2:null, tip:"Elevated scenic ride. Short waits all day. Nice breather between bigger rides." },
  { id:"cathat",     name:"The Cat in the Hat",                    land:"Seuss Landing",  park:"ioa",     minH:36, express:true,  single:false, dur:4,  thrill:false, day1:4,  day2:null, tip:"Classic family dark ride. Low waits all day. Great for the little one." },
  { id:"onefish",    name:"One Fish, Two Fish, Red Fish, Blue Fish",land:"Seuss Landing",  park:"ioa",     minH:0,  express:false, single:false, dur:3,  thrill:false, day1:5,  day2:null, tip:"Kids water spinner. No height req. Try to dodge the water jets — you won't." },
  { id:"hogex_ioa",  name:"Hogwarts Express (Hogsmeade)",          land:"Hogsmeade",      park:"ioa",     minH:0,  express:false, single:false, dur:18, thrill:false, day1:6,  day2:null, isTransport:true, tip:"P2P ticket required. Departs Hogsmeade → King's Cross. Completely different experience from the return trip." },
  { id:"dudley",     name:"Dudley Do-Right's Ripsaw Falls",         land:"Toon Lagoon",    park:"ioa",     minH:44, express:true,  single:false, dur:6,  thrill:false, day1:null,day2:null, optional:true, tip:"Flume ride — very wet. Play by ear based on heat. Express works here." },
  { id:"veloci",     name:"Jurassic World VelociCoaster",           land:"Jurassic Park",  park:"ioa",     minH:51, express:true,  single:true,  dur:4,  thrill:true,  day1:null,day2:1, tip:"Best coaster in the resort. Express works. Single rider line cuts wait significantly." },
  { id:"ptero",      name:"Pteranodon Flyers",                      land:"Jurassic Park",  park:"ioa",     minH:36, express:false, single:false, dur:3,  thrill:false, day1:null,day2:2, maxH:56, tip:"Kids 36-56\" only. Adults over 56\" must ride WITH a child. No Express. Go right after VelociCoaster." },
  { id:"kong",       name:"Skull Island: Reign of Kong",            land:"Skull Island",   park:"ioa",     minH:36, express:true,  single:false, dur:7,  thrill:false, day1:null,day2:3, tip:"Surprisingly good dark ride. Express works. Good mid-morning slot." },
  { id:"spiderman",  name:"Amazing Adventures of Spider-Man",       land:"Marvel Island",  park:"ioa",     minH:40, express:true,  single:true,  dur:5,  thrill:false, day1:null,day2:5, tip:"Classic motion sim — still holds up. Single rider available." },
  { id:"hulk",       name:"Incredible Hulk Coaster",                land:"Marvel Island",  park:"ioa",     minH:54, express:true,  single:false, dur:3,  thrill:true,  day1:null,day2:6, tip:"Loud launch coaster. Express works." },
  { id:"doom",       name:"Doctor Doom's Fearfall",                 land:"Marvel Island",  park:"ioa",     minH:52, express:true,  single:false, dur:2,  thrill:true,  day1:null,day2:null, optional:true, tip:"Drop tower. Short ride. Good Express use if you have time." },
  { id:"stormforce", name:"Storm Force Accelatron",                 land:"Marvel Island",  park:"ioa",     minH:0,  express:false, single:false, dur:3,  thrill:false, day1:null,day2:null, optional:true, tip:"Simple spinner. No height req. Low waits — good filler." },
  { id:"bilge",      name:"Popeye & Bluto's Bilge-Rat Barges",     land:"Toon Lagoon",    park:"ioa",     minH:42, express:true,  single:false, dur:6,  thrill:false, day1:null,day2:null, optional:true, tip:"The WETTEST ride in both parks. Afternoon only. Bring a poncho." },
  { id:"caroSeuss",  name:"Caro-Seuss-el",                          land:"Seuss Landing",  park:"ioa",     minH:0,  express:false, single:false, dur:3,  thrill:false, day1:null,day2:null, optional:true, tip:"Themed carousel. Very low waits. Good for the youngest rider." },
  { id:"gringotts",  name:"Harry Potter & Escape from Gringotts",  land:"Diagon Alley",   park:"studios", minH:42, express:true,  single:true,  dur:6,  thrill:true,  day1:7,  day2:null, tip:"Headliner at Studios. Hybrid coaster + dark ride. Single rider available." },
  { id:"mib",        name:"Men in Black Alien Attack",              land:"World Expo",     park:"studios", minH:42, express:true,  single:false, dur:5,  thrill:false, day1:8,  day2:null, tip:"Interactive shooter — your group's score matters. Express works." },
  { id:"simpsons",   name:"The Simpsons Ride",                      land:"Springfield",    park:"studios", minH:40, express:true,  single:false, dur:5,  thrill:false, day1:9,  day2:null, tip:"Dome-screen motion sim. Waits stay moderate. Good afternoon slot." },
  { id:"trollscoast",name:"Trolls Trollercoaster",                  land:"DreamWorks Land",park:"studios", minH:36, express:true,  single:false, dur:3,  thrill:false, day1:9,  day2:null, tip:"Family coaster right in DreamWorks Land. Low waits." },
  { id:"et",         name:"E.T. Adventure",                         land:"DreamWorks Land",park:"studios", minH:34, express:true,  single:false, dur:5,  thrill:false, day1:10, day2:null, tip:"Classic gentle dark ride. Perfect wind-down for the littlest rider (34\"+)." },
  { id:"minion",     name:"Despicable Me Minion Mayhem",            land:"Minion Land",    park:"studios", minH:40, express:true,  single:false, dur:6,  thrill:false, day1:null,day2:7, tip:"High-capacity family ride. Waits manageable." },
  { id:"villaincon", name:"Villain-Con Minion Blast",               land:"Minion Land",    park:"studios", minH:0,  express:false, single:false, dur:8,  thrill:false, day1:null,day2:8, tip:"Interactive blaster walk-through. No height req. No Express but waits are low." },
  { id:"fallon",     name:"Race Through New York (Jimmy Fallon)",   land:"New York",       park:"studios", minH:40, express:true,  single:false, dur:5,  thrill:false, day1:null,day2:9, tip:"Air-conditioned queue — great for the hottest part of the day." },
  { id:"mummy",      name:"Revenge of the Mummy",                   land:"New York",       park:"studios", minH:48, express:true,  single:true,  dur:3,  thrill:true,  day1:null,day2:10, tip:"Underrated indoor coaster with real fire effects. Express + single rider both work." },
  { id:"transformers",name:"Transformers: The Ride 3D",             land:"Production Ctrl",park:"studios", minH:40, express:true,  single:true,  dur:5,  thrill:false, day1:null,day2:null, optional:true, tip:"Solid motion sim. High capacity — shorter waits. Single rider available." },
  { id:"kang",       name:"Kang & Kodos' Twirl 'n' Hurl",          land:"Springfield",    park:"studios", minH:0,  express:false, single:false, dur:3,  thrill:false, day1:null,day2:null, optional:true, tip:"Simple spinner. No height req. Low waits, fun filler." },
  { id:"hogex_st",   name:"Hogwarts Express (King's Cross)",        land:"Diagon Alley",   park:"studios", minH:0,  express:false, single:false, dur:18, thrill:false, day1:null,day2:null, isTransport:true, tip:"P2P ticket required. Departs King's Cross to Hogsmeade. Completely different from the Hogsmeade departure." },
];
...
const FOOD = {
  ...
  "Minion Land":    { sitdown:{name:"Minion Cafe",                item:"Themed bowls and sandwiches",  emoji:"🍌"}, snack:{name:"Minion Cafe outside",     item:"Bello Ice Cream cone",       emoji:"🍦"}, drink:{name:"Minion Cafe",          item:"Blended freeze",                  emoji:"🥤"} },
...
function buildDaySchedule({ dayNum, hasExpress, hasEPA, liveWaits, parks, cfg, overrideOrder }) {
  ...
  function buildBlock(rides, blockStart, blockEnd, startLand, startPark, crossingDone) {
    ...
    for (const ride of rides) {
      ...
      if (lastPark === "ioa" && ride.park === "studios" && !crossingDone && parks === "all") {
        ...
        items.push({ type:"crossing", startMins:cur, endMins:cur+25, id:"crossing", park:"ioa", land:"Hogsmeade", note:"Board at Hogsmeade to King's Cross / Diagon Alley. P2P ticket required." });
        cur += 25;
        crossingDone = true;
  ...
  if (hasEPA && firstRide) {
    scheduled.push({ type:"epa", id:"epa-start", park:firstRide.park, land:firstRide.land, startMins:startMins, label:firstRide.park === "ioa" ? "Islands of Adventure" : "Universal Studios Florida", sub:dayNum===1 ? "Early Park Admission - Hogsmeade first" : "Early Park Admission - Jurassic Park first" });
  }
  ...
  if (cfg.hotelBreak) {
    ...
    const PARADE_TIME = 19 * 60;
    const CINE_TIME = 21 * 60;
    ...
    scheduled.push({ type:"event", id:"parade", startMins:PARADE_TIME, emoji:"🎬", label:"Universal Mega Movie Parade", sub:"Studios lagoon - Get there 20 min early - Passholders have exclusive viewing area", color:"#F87171" });
    ...
    scheduled.push({ type:"event", id:"cinesational", startMins:CINE_TIME, emoji:"🎆", label:"Cinesational: A Symphonic Spectacular", sub:"Studios fountains - Pyrotechnics - Harry Potter, Jaws & Mummy soundtracks", color:"#818CF8" });
  } else {
    if (morning.lastLand) {
      const exitWalk = ENTRANCE_WALK[morning.lastLand] ?? 10;
...
function Chip({ label, color, size="sm" }) {
  return <span style={{display:"inline-flex",alignItems:"center",background:al(color,0.12),color,border:"1px solid "+al(color,0.28),borderRadius:20,padding:size==="xs"?"1px 6px":"2px 8px",fontSize:size==="xs"?9:10,fontWeight:800,whiteSpace:"nowrap"}}>{label}</span>;
}
          ...
          <div className="fade-up" style={{marginBottom:24,padding:"16px",borderRadius:14,background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.06)"}}>
            ...
            {hotelBreak && (
              <div style={{display:"flex",gap:12,alignItems:"center"}}>
                ...
                <div style={{fontSize:18,color:"#2d4060",marginTop:14}}>to</div>
                <div style={{flex:1}}>
...
export default function App() {
  ...
  const parkColor = (p) => PARK[p]?.color || "#818CF8";
          ...
          <div>
            {scheduled.map((item,idx) => {
              if (item.type==="walk") return (
                <div key={item.id} style={{display:"flex",alignItems:"center",gap:8,padding:"4px 4px",opacity:0.4}}>
                  ...
                  <div style={{fontSize:9,color:"#2d4060"}}>
                    {item.isEntrance?"Walk: entrance to "+(LAND_META[item.to]?.short||item.to):item.isExit?"Walk: "+(LAND_META[item.from]?.short||item.from)+" to exit":"Walk: "+(LAND_META[item.from]?.short||item.from)+" to "+(LAND_META[item.to]?.short||item.to)} - {item.endMins-item.startMins} min
                  </div>
                </div>
              );
              ...
              if (item.type==="break") return (
                <div key={item.id} className="fade-up" style={{marginBottom:12,borderRadius:14,background:"linear-gradient(135deg,rgba(52,211,153,0.10),rgba(129,140,248,0.06))",border:"1.5px solid rgba(52,211,153,0.2)",padding:"16px 18px"}}>
                  ...
                  <div style={{marginTop:10,display:"flex",gap:8}}>
                    <div style={{padding:"5px 12px",borderRadius:20,background:"rgba(251,191,36,0.12)",border:"1px solid rgba(251,191,36,0.2)",fontSize:11,color:"#FBBF24",fontWeight:800}}>{fmt12(item.startMins)} to {fmt12(item.endMins)}</div>
                  </div>
                </div>
              );
              ...
              return (
                ...
                >
                  <div style={{borderRadius:14,overflow:"hidden",border:"1.5px solid "+(isExp?al(pc,0.45):closed?"rgba(248,113,113,0.25)":al(pc,0.12)),background:closed?"rgba(248,113,113,0.03)":al(pc,0.03),transition:"border-color 0.15s"}}>
                    <div onClick={()=>setExpandedId(isExp?null:item.id)} className="pop" style={{padding:"11px 13px",display:"flex",gap:10,alignItems:"flex-start",cursor:"pointer"}}>
                      <div style={{width:40,minHeight:40,borderRadius:10,flexShrink:0,flexDirection:"column",background:closed?"rgba(248,113,113,0.08)":al(wc,0.12),border:"1.5px solid "+(closed?"rgba(248,113,113,0.3)":al(wc,0.28)),display:"flex",alignItems:"center",justifyContent:"center"}}>
                        {closed ? (
                          <div style={{fontSize:8,color:"#F87171",fontWeight:900,textAlign:"center",lineHeight:1.2}}>CLOS ED</div>
                        ) : (
                          <>
                      ...
                      <div style={{textAlign:"right",flexShrink:0}}>
                        {!closed&&<><div style={{fontSize:12,fontWeight:800,color:pc}}>{fmt12(item.startMins)}</div><div style={{fontSize:10,color:"#3d5470",marginTop:1}}>{fmt12(item.endMins)}</div></>}
                        <div style={{fontSize:10,color:"#2d4060",marginTop:1}}>drag</div>
                      </div>
                    </div>
                    {isExp&&(
                      <div className="fade-up" style={{borderTop:"1px solid "+al(pc,0.10),padding:"11px 13px"}}>
                  ...
                  return (
                    <div key={ride.id} style={{marginBottom:6,borderRadius:11,background:closed?"rgba(248,113,113,0.03)":"rgba(255,255,255,0.02)",border:"1px solid "+(closed?"rgba(248,113,113,0.2)":al(wc,0.12)),padding:"9px 12px",display:"flex",alignItems:"center",gap:10,opacity:closed?0.7:1}}>
                      <div style={{width:38,textAlign:"center",flexShrink:0}}>
                        {closed?<div style={{fontSize:9,color:"#F87171",fontWeight:900,lineHeight:1.2}}>CLOSED</div>:<>
        ...
        {activeTab==="tips"&&(
          <div>
            {[
              ...
              { emoji:"🚂", title:"Hogwarts Express - Both Directions", body:"Hogsmeade to King's Cross and King's Cross to Hogsmeade are completely different experiences. Ride both if you have a P2P ticket - don't skip one direction." },
              ...
              { emoji:"🦕", title:"Pteranodon Flyers - The Weird Rule", body:"Kids 36-56 inches only. Adults over 56 inches must ride WITH a child. No Express. Go right after VelociCoaster before it hits capacity." },
